...
export const DEFAULT_EXERCISES: Exercise[] = [
  // ── Push ──
  { id: "incline-bb-bench", name: "Incline Barbell Bench (30\u00b0)", primaryMuscle: "Upper Chest", secondaryMuscles: ["Shoulders", "Triceps"], equipment: "Barbell" },
  ...
  { id: "cable-lateral-raise", name: "Cable Lateral Raise", primaryMuscle: "Side Delts", secondaryMuscles: [], equipment: "Cable" },
  ...
  { id: "lat-pulldown-neutral", name: "Lat Pulldown (Neutral Grip)", primaryMuscle: "Lats", secondaryMuscles: ["Biceps"], equipment: "Cable" },
  { id: "seated-cable-row", name: "Seated Cable Row (Close Grip)", primaryMuscle: "Mid Back", secondaryMuscles: ["Biceps", "Lats"], equipment: "Cable" },
  { id: "face-pulls", name: "Face Pull", primaryMuscle: "Rear Delts", secondaryMuscles: ["Traps"], equipment: "Cable" },
  ...
  { id: "hamstring-curls", name: "Hamstring Curl", primaryMuscle: "Hamstrings", secondaryMuscles: [], equipment: "Machine" },
  { id: "bulgarian-split-squat", name: "Bulgarian Split Squat", primaryMuscle: "Quads", secondaryMuscles: ["Glutes", "Hamstrings"], equipment: "Dumbbells" },
  { id: "standing-calf-raises", name: "Standing Calf Raise", primaryMuscle: "Calves", secondaryMuscles: [], equipment: "Machine" },
  { id: "seated-calf-raises", name: "Seated Calf Raise", primaryMuscle: "Calves", secondaryMuscles: [], equipment: "Machine" },
  { id: "cable-crunch", name: "Cable Crunch", primaryMuscle: "Abs", secondaryMuscles: [], equipment: "Cable" },
